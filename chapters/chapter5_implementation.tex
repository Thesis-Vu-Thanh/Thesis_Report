...
\begin{itemize}
	...
	\item \textbf{Second 1D CNN layer}. Another sequence of 1D CNN\index{CNN} layers follows to learn higher-level features. The output matrix after those two layers is an 18 x 512 matrix. 
