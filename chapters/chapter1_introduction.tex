...
\label{sec:structure}
	...
	\fullref{chap:literature} Chương này chúng tôi giới thiệu hai công trình liên quan sử dụng mạng học sâu để phân đoạn hình ảnh y khoa. Công trình thứ nhất sử dụng mạng U-Net trong phân đoạn hình ảnh 2D\nomenclature{2D}{Two Dimensional} và công trình thứ hai sử dụng mạng DeepVesselNet trong phân đoạn hình ảnh 3D\nomenclature{3D}{Three Dimensional}.\nextintro
