...
In this chapter, we want to describe the datasets used to train and evaluate the Logistics Regression module and CNN\index{CNN} categorize module, with the problems of datasets and pre-processing details. 
