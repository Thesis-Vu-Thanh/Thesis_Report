...
Our architecture is described in the below figure (Figure 4.1). Suggest a reasonable decision model for the combined 
\begin{figure}[!h]
...
\end{tabular}
\end{center}
\caption{\label{demo-table} Decision model}
\end{table}
