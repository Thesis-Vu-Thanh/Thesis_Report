...
\makenomenclature
\renewcommand{\nompreamble}{
	\textit{Danh sách dưới đây liệt kê các chữ cái viết tắt sẽ được sử dụng về sau trong nội dung cuốn luận văn này.}
%	\begin{multicols}{2}
}
\renewcommand{\nompostamble}{
%	\end{multicols}
...
\makeatletter
	...
	{
		\addtocontents{toc}{\protect\renewcommand{\protect\cftchappresnum}{Table of Contents}}
		\renewcommand{\chaptername}{TABLE OF CONTENTS}
	}
\makeatother
...
[
	%columns=3, 
	title=Danh mục từ khoá, 
	options=-s styles/indexstyle.ist
]
\indexprologue{\textit{Danh sách dưới đây liệt kê các từ khoá được đề cập trong nội dung luận văn này theo thứ tự bảng chữ cái.}}
